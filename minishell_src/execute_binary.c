...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/05/02 20:07:46 by bandre            #+#    #+#             */
/*   Updated: 2018/05/02 20:13:12 by bandre           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	count(t_libft_chained_list **env,
	...
	t_libft_chained_list *maillon, void *params)
{
	...
	if (ft_strncmp(maillon->data, search_struct->searched,
		ft_strlen(search_struct->searched)) == 0)
	{
		if (((char*)maillon->data)[ft_strlen(search_struct->searched)] == '=')
		{
			search_struct->result = maillon->data +
				ft_strlen(search_struct->searched) + 1;
		}
	}
	do_nothing((void*)env);
}

void	complete(t_libft_chained_list **env,
	t_libft_chained_list *maillon, void *params)
{
	t_complete *elem;
