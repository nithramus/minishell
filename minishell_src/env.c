...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/05/02 20:04:08 by bandre            #+#    #+#             */
/*   Updated: 2018/05/02 20:07:10 by bandre           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	t_libft_chained_list *maillon, void *params)
{
	...
	param = (t_env*)params;
	if (ft_strncmp(maillon->data, param->envname,
		ft_strlen(param->envname)) == 0)
	{
...
void	delete_env_parameter(t_libft_chained_list **env,
	t_libft_chained_list *maillon, void *params)
{
	t_env *param;
